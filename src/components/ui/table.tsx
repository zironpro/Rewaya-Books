...
export function TableHead({
	...
	return (
		<th
			className={cn(
				"h-10 whitespace-nowrap px-2.5 text-start align-middle font-medium text-muted-foreground leading-none has-[[role=checkbox]]:w-px last:has-[[role=checkbox]]:ps-0 first:has-[[role=checkbox]]:pe-0",
				className
			)}
