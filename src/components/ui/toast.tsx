		...
		<Toast.Portal data-slot="toast-portal" {...portalProps}>
			<Toast.Viewport
				className={cn(
					...
					"data-[position*=left]:inset-s-(--toast-inset)",
					"data-[position*=right]:inset-e-(--toast-inset)",
					"data-[position*=center]:inset-s-1/2 data-[position*=center]:-translate-x-1/2 rtl:data-[position*=center]:translate-x-1/2"
				)}
					...
					return (
						<Toast.Root
							className={cn(
								...
								"data-[position*=right]:inset-e-0 data-[position*=right]:inset-s-auto",
								"data-[position*=left]:inset-e-auto data-[position*=left]:inset-s-0",
								"data-[position*=center]:inset-e-0 data-[position*=center]:inset-s-0",
								...
								// Gap fill for hover
								"after:absolute after:inset-s-0 after:h-[calc(var(--toast-gap)+1px)] after:w-full",
